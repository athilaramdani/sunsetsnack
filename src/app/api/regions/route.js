...
export async function GET() {
    try {
      ...
      // Mengurutkan kota-kota di dalam setiap provinsi secara alfabetis
      ...
      return new NextResponse(JSON.stringify(provinsi), {
        status: 200,
        headers: {
      ...
      return new NextResponse(JSON.stringify({ error: 'Error fetching regions' }), {
        status: 500,
        headers: {
          'Content-Type': 'application/json',
        },
